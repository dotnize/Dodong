...
module.exports = new Command({
	...
	async run(message, args, client) {
        ...
        `**[Join my server](https://nize.ph/discord)** or **[invite me](https://discord.com/oauth2/authorize?client_id=834688899476881411&permissions=36785472&scope=bot)** to your server!\n\n`+
