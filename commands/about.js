...
module.exports = new Command({
	...
	async run(message, args, client) {
        ...
        embed.setAuthor("All about Noize", client.user.displayAvatarURL())
        embed.setDescription(`Hi there! I am **Noize**, and I'm an open-source music bot written in JavaScript using [Node.js](https://nodejs.org), [discord.js](https://discord.js.org), and [discord-player](https://discord-player.js.org).\n`+
        ...
        `\`\`\``+
        `[View on GitHub](https://github.com/nizeic/Noize)`);
